...
**NOTE:** LocalCoin requires an [OpenSSL](https://www.openssl.org/) version in the 1.0.x series. OpenSSL 1.1.0 and newer are NOT supported. If your system OpenSSL version is newer, then you will need to manually provide an older version of OpenSSL and specify it to CMake using `-DOPENSSL_INCLUDE_DIR`, `-DOPENSSL_SSL_LIBRARY`, and `-DOPENSSL_CRYPTO_LIBRARY`.

**NOTE:** LocalCoin requires a [Boost](http://www.boost.org/) version in the range [1.57, 1.63]. Versions earlier than
...
**NOTE:** By default the witness node will start in reduced memory ram mode by using some of the commands detailed in [Memory reduction for nodes](https://github.com/localcoinis/localcoin-core/wiki/Memory-reduction-for-nodes).
...
[here](https://github.com/localcoinis/localcoin-core/blob/master/libraries/wallet/include/graphene/wallet/wallet.hpp).
...
- The answer to the previous question was really confusing.  Can you make it clearer?
    ...
    your asset's ID will be `1.3.29`.  Asset `0` is special (it's LLC, which is considered the "core asset").
...
License
-------
LocalCoin Core is under the MIT license. See [LICENSE](https://github.com/localcoinis/localcoin-core/blob/master/LICENSE.txt)
